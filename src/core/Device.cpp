...
Device* Modulos::device =0x0;
Driver* Modulos::driver =0x0;
Logger* Modulos::logger =0x0;
System* Modulos::system =0x0;
TextureManager* Modulos::textureManager =0x0;
MeshBuilder *Modulos::meshBuilder =0x0;
