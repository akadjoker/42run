...
bool System::LoadDirectoryFiles(const char *dirPath,  Array<String> &files)
{
...
bool System::LoadDirectoryFiles(const char *dirPath, const char *filter, Array<String> &files)
{
     DIR *dir = opendir(dirPath);
...
bool System::LoadDirectoryFiles(const char *basePath, const char *filter, bool scanSubdirs,  Array<String> &files)
{
...
bool System::ScanDirectoryFiles(const char *basePath,   Array<String> &files, const char *filter)
{
...
// Scan all files and directories recursively from a base path
 bool System::ScanDirectoryFilesRecursively(const char *basePath,   Array<String> &files, const char *filter)
{
    char path[512] = { 0 };
    memset(path, 0, 512);
