...
int Shader::getAttribute(const String &name) 
{
...
int Shader::getAttribLocation( const String &attribName) const
{
...
void Shader::SetMatrix4(const String &name, const float *value)
{
     int id = getUniform(name);
    if (id != -1)
...
void Shader::SetMatrix3(const String &name, const float *value)
{
    int id = getUniform(name);
    if (id != -1)
...
void Shader::SetFloat(const String& name, float x, float y)
{
    int id = getUniform(name);
    if (id != -1)
        glUniform2f(id,  x,y);
}
void Shader::SetFloat(const String& name,float x, float y, float z)
{
   int id = getUniform(name);
    if (id != -1)
        glUniform3f(id, x, y, z);
}
void Shader::SetFloat(const String& name, float x, float y, float z, float w)
{
	int id = getUniform(name);
    if (id != -1)
