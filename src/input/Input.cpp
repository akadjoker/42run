...
Vec2 Mouse::currentPosition;
Vec2 Mouse::previousPosition;
char Mouse::currentButtonState[Mouse::MAX_BUTTONS];
char Mouse::previousButtonState[Mouse::MAX_BUTTONS];
Vec2 Mouse::currentWheelMove;
Vec2 Mouse::previousWheelMove;
Vec2 Mouse::offset;
Vec2 Mouse::scale;
...
void Mouse::Init()
{
    ...
    currentWheelMove=Vec2(0, 0);
    previousWheelMove=Vec2(0, 0);
